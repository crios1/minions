...
In Minions, your workflow runs in one event loop. If you do CPU-heavy or blocking work in a step, you can stall unrelated workflow work. Offload CPU to a separate process; offload blocking I/O to a thread.
