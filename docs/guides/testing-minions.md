...
- **Simulate persistence**: ensure context objects round-trip through your state store implementation; assert that `next_step_index` increments and contexts are deleted on success.
