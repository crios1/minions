...
- todo: audit the Gru scenario DSL semantic model and internal structure
  ...
  - findings to revisit together:
    ...
    - aggregate Resource lifecycle counts cannot be hardcoded to one per class because Gru may stop an unowned Resource and later create a replacement instance; the verifier now derives successful running-instance counts from runner-recorded instance tags and separately accounts for newly observed partial Minion, Pipeline, and Resource lifecycles from failed starts; broader lifecycle-result ownership and stop/shutdown semantics remain part of this holistic design work
